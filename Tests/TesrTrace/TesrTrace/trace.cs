...
namespace Transport_company
{
    class Trace<T> 
    {
        ...
        DoublyNode<T> Tail;
        int Count;
        public void Add(T Start, T Finish, DateTime dateTime, float mass)
        {
            DoublyNode<T> node = new DoublyNode<T>(Start, Finish, dateTime, mass);
    ...
    {
        public DoublyNode(T start, T finish, DateTime dateTime, float mass)
        {
            Start1 = start;
            Finish1 = finish;
            Time1 = dateTime;
